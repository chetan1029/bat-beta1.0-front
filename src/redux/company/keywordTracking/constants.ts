...
export enum KeywordTrackingTypes {
    API_RESPONSE_SUCCESS = '@@company/keywordTracking/API_RESPONSE_SUCCESS',
    API_RESPONSE_ERROR = '@@company/keywordTracking/API_RESPONSE_ERROR',

...
const TabMenu = ({ onChange, selectedView }) => {
	...
	return <div className="px-2 pb-2 mb-4">
		<Nav variant="tabs" className="nav-bordered m-0" activeKey={selectedView} onSelect={onChange} as='ul'>
			<Nav.Item as="li">
				<Nav.Link className="pt-1" eventKey={description_tab}>{t('Description')}</Nav.Link>
			</Nav.Item>
			<Nav.Item as="li">
				...
				<div className="py-4 px-3">
					...
					<Card className="mt-3">
						<Card.Body className={"pt-3"}>
							<Row>
								<Col lg={selectedView === description_tab ? 8 : 12} md={selectedView === description_tab ? 8 : 12} sm={12} className="pr-5">
									<TabMenu onChange={onChangeTab} selectedView={selectedView} />
									{renderContent()}
								</Col>
								{
									selectedView === description_tab && <Col lg={4} md={4} sm={12}>

...
//action
import { createComponentPackingBox, editComponentPackingBox, reset, getPackingBox } from "../../../redux/actions";
...
const AddEditPackingBox = ({ isOpen, onClose, defaultPackingBox, companyId, componentId, productId }: AddEditPackingBoxProps) => {
    ...
    const validator = useFormik({
        ...
        onSubmit: values => {
            ...
            if (!!defaultPackingBox) {
                ...
                dispatch(createComponentPackingBox(companyId, componentId, { ...values, packingbox: get(values, 'packingbox.value'), product: productId }));
            }
        },
    });

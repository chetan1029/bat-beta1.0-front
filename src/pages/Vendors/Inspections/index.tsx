...
const VendorInspections = (props: VendorsProps) => {
                    ...
                    <Card>
                        <Card.Body className="">
                            {loading ? <Loader /> : <div>
                                ...
                                <TabMenu items={tabMenuItems} defaultSelectedItem={'inspections'} />

                                <Row>
                                    <Col lg={6}>Inspections</Col>
                                    <Col lg={6}></Col>
                                </Row>
                            </div>}
                        </Card.Body>
...
export default withRouter(VendorInspections);

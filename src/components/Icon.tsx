...
const Icon = ({ name, className }: Props) => {
  const renderSvg = (iconName: string) => {
    switch (iconName) {
      ...
      case 'box-3':
        return <svg width="31" height="36" viewBox="0 0 31 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M30.8407 9.68884C30.8407 9.68884 30.8407 9.68884 30.8407 9.5445L30.7324 9.27385C30.6947 9.21642 30.6525 9.16212 30.6061 9.11146C30.5578 9.03508 30.5035 8.96268 30.4437 8.89495L30.2813 8.76864L29.9926 8.6243L16.4603 0.270353C16.1736 0.0911263 15.8422 -0.00390625 15.504 -0.00390625C15.1659 -0.00390625 14.8345 0.0911263 14.5477 0.270353L1.1237 8.6243L0.961308 8.76864L0.79892 8.89495C0.73911 8.96268 0.684808 9.03508 0.636533 9.11146C0.590147 9.16212 0.54791 9.21642 0.510231 9.27385L0.401972 9.5445C0.401972 9.5445 0.401972 9.5445 0.401972 9.68884C0.384238 9.84471 0.384238 10.0021 0.401972 10.158V25.9276C0.401359 26.2342 0.478901 26.536 0.627278 26.8043C0.775656 27.0727 0.989974 27.2988 1.25 27.4613L14.7823 35.8152C14.8656 35.8667 14.9572 35.9033 15.053 35.9235C15.053 35.9235 15.1432 35.9235 15.1973 35.9235C15.5026 36.0203 15.8303 36.0203 16.1355 35.9235C16.1355 35.9235 16.2258 35.9235 16.2799 35.9235C16.3757 35.9033 16.4672 35.8667 16.5505 35.8152L29.9926 27.4613C30.2527 27.2988 30.467 27.0727 30.6153 26.8043C30.7637 26.536 30.8413 26.2342 30.8407 25.9276V10.158C30.8584 10.0021 30.8584 9.84471 30.8407 9.68884ZM13.7539 31.0518L3.83016 24.9172V13.4057L13.7539 19.5223V31.0518ZM15.5582 16.4009L5.45404 10.158L15.5582 3.9331L25.6623 10.158L15.5582 16.4009ZM27.2862 24.9172L17.3625 31.0518V19.5223L27.2862 13.4057V24.9172Z" fill="#1A6EF5" />
        </svg>
